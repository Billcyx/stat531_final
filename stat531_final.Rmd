...
based on the AIC and smallest root, the relatively suitable model we choose is ARIMA(1,1,5) with smallest root as 1.05
```{r, graphsecho=FALSE,warning=FALSE}
library(knitr)
